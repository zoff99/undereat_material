...
import com.zoffcc.applications.undereat.AudioBar.audio_in_bar
import com.zoffcc.applications.undereat.AudioBar.audio_out_bar
import com.zoffcc.applications.undereat.HelperFiletransfer.check_auto_accept_incoming_filetransfer
import com.zoffcc.applications.undereat.HelperFiletransfer.get_incoming_filetransfer_local_filename
import com.zoffcc.applications.undereat.HelperFiletransfer.insert_into_filetransfer_db
import com.zoffcc.applications.undereat.HelperFiletransfer.move_tmp_file_to_real_file
import com.zoffcc.applications.undereat.HelperFiletransfer.set_message_accepted_from_id
import com.zoffcc.applications.undereat.HelperFiletransfer.update_filetransfer_db_full
import com.zoffcc.applications.undereat.HelperFriend.add_friend_avatar_chunk
import com.zoffcc.applications.undereat.HelperFriend.add_pushurl_for_friend
import com.zoffcc.applications.undereat.HelperFriend.del_friend_avatar
import com.zoffcc.applications.undereat.HelperFriend.get_friend_name_from_num
import com.zoffcc.applications.undereat.HelperFriend.main_get_friend
import com.zoffcc.applications.undereat.HelperFriend.remove_pushurl_for_friend
import com.zoffcc.applications.undereat.HelperFriend.send_friend_msg_receipt_v2_wrapper
import com.zoffcc.applications.undereat.HelperFriend.update_friend_in_db_capabilities
import com.zoffcc.applications.undereat.HelperFriend.update_friend_in_db_msgv3_capability
import com.zoffcc.applications.undereat.HelperFriend.update_friend_msgv3_capability
import com.zoffcc.applications.undereat.HelperGeneric.PubkeyShort
import com.zoffcc.applications.undereat.HelperGeneric.bytesToHex
import com.zoffcc.applications.undereat.HelperGeneric.get_friend_msgv3_capability
import com.zoffcc.applications.undereat.HelperGeneric.hexstring_to_bytebuffer
import com.zoffcc.applications.undereat.HelperGeneric.io_file_copy
import com.zoffcc.applications.undereat.HelperGeneric.play_ngc_incoming_audio_frame
import com.zoffcc.applications.undereat.HelperGeneric.read_chunk_from_SD_file
import com.zoffcc.applications.undereat.HelperGeneric.show_ngc_incoming_video_frame_v2
import com.zoffcc.applications.undereat.HelperGeneric.shrink_image_file
import com.zoffcc.applications.undereat.HelperGeneric.update_savedata_file_wrapper
import com.zoffcc.applications.undereat.HelperGroup.bytebuffer_to_hexstring
import com.zoffcc.applications.undereat.HelperGroup.bytes_to_hex
import com.zoffcc.applications.undereat.HelperGroup.fourbytes_of_long_to_hex
import com.zoffcc.applications.undereat.HelperGroup.get_last_group_message_in_this_group_within_n_seconds_from_sender_pubkey
import com.zoffcc.applications.undereat.HelperGroup.handle_incoming_group_file
import com.zoffcc.applications.undereat.HelperGroup.handle_incoming_sync_group_file
import com.zoffcc.applications.undereat.HelperGroup.handle_incoming_sync_group_message
import com.zoffcc.applications.undereat.HelperGroup.send_group_image
import com.zoffcc.applications.undereat.HelperGroup.send_ngch_request
import com.zoffcc.applications.undereat.HelperGroup.sync_group_message_history
import com.zoffcc.applications.undereat.HelperGroup.tox_group_by_groupid__wrapper
import com.zoffcc.applications.undereat.HelperGroup.tox_group_by_groupnum__wrapper
import com.zoffcc.applications.undereat.HelperMessage.process_msgv3_high_level_ack
import com.zoffcc.applications.undereat.HelperMessage.sync_messagev2_answer
import com.zoffcc.applications.undereat.HelperMessage.update_message_in_db_read_rcvd_timestamp_rawmsgbytes
import com.zoffcc.applications.undereat.HelperMessage.update_single_message_from_ftid
import com.zoffcc.applications.undereat.HelperMessage.update_single_message_from_messge_id
import com.zoffcc.applications.undereat.HelperRelay.get_own_relay_pubkey
import com.zoffcc.applications.undereat.HelperRelay.get_pushurl_for_friend
import com.zoffcc.applications.undereat.HelperRelay.have_own_relay
import com.zoffcc.applications.undereat.HelperRelay.invite_to_all_groups_own_relay
import com.zoffcc.applications.undereat.HelperRelay.is_any_relay
import com.zoffcc.applications.undereat.HelperRelay.is_own_relay
import com.zoffcc.applications.undereat.HelperRelay.send_all_friend_pubkeys_to_relay
import com.zoffcc.applications.undereat.HelperRelay.send_friend_pubkey_to_relay
import com.zoffcc.applications.undereat.HelperRelay.send_pushtoken_to_relay
import com.zoffcc.applications.undereat.HelperRelay.send_relay_pubkey_to_friend
import com.zoffcc.applications.undereat.TRIFAGlobals.ABSOLUTE_MINIMUM_GLOBAL_VIDEO_BITRATE
import com.zoffcc.applications.undereat.TRIFAGlobals.AVATAR_INCOMING_MAX_BYTE_SIZE
import com.zoffcc.applications.undereat.TRIFAGlobals.GLOBAL_AUDIO_BITRATE
import com.zoffcc.applications.undereat.TRIFAGlobals.GLOBAL_VIDEO_BITRATE
import com.zoffcc.applications.undereat.TRIFAGlobals.GROUP_ID_LENGTH
import com.zoffcc.applications.undereat.TRIFAGlobals.HIGHER_GLOBAL_VIDEO_BITRATE
import com.zoffcc.applications.undereat.TRIFAGlobals.HIGH_GLOBAL_INCOMING_AV_BUFFER_MS
import com.zoffcc.applications.undereat.TRIFAGlobals.LOWER_GLOBAL_VIDEO_BITRATE
import com.zoffcc.applications.undereat.TRIFAGlobals.LOWER_NGC_VIDEO_BITRATE
import com.zoffcc.applications.undereat.TRIFAGlobals.LOWER_NGC_VIDEO_QUANTIZER
import com.zoffcc.applications.undereat.TRIFAGlobals.MEDIUM_GLOBAL_VIDEO_BITRATE
import com.zoffcc.applications.undereat.TRIFAGlobals.MESSAGE_GROUP_HISTORY_SYNC_DOUBLE_INTERVAL_SECS
import com.zoffcc.applications.undereat.TRIFAGlobals.NGC_AUDIO_BITRATE
import com.zoffcc.applications.undereat.TRIFAGlobals.NORMAL_GLOBAL_INCOMING_AV_BUFFER_MS
import com.zoffcc.applications.undereat.TRIFAGlobals.NORMAL_GLOBAL_VIDEO_BITRATE
import com.zoffcc.applications.undereat.TRIFAGlobals.TRIFA_MSG_TYPE
import com.zoffcc.applications.undereat.TRIFAGlobals.UINT32_MAX_JAVA
import com.zoffcc.applications.undereat.TRIFAGlobals.UPDATE_MESSAGE_PROGRESS_AFTER_BYTES
import com.zoffcc.applications.undereat.TRIFAGlobals.UPDATE_MESSAGE_PROGRESS_AFTER_BYTES_SMALL_FILES
import com.zoffcc.applications.undereat.TRIFAGlobals.UPDATE_MESSAGE_PROGRESS_SMALL_FILE_IS_LESS_THAN_BYTES
...
import com.zoffcc.applications.undereat.TRIFAGlobals.global_last_activity_outgoung_ft_ts
import com.zoffcc.applications.undereat.TRIFAGlobals.global_self_connection_status
import com.zoffcc.applications.undereat.TRIFAGlobals.global_self_last_went_offline_timestamp
import com.zoffcc.applications.undereat.ToxVars.TOX_CAPABILITY_DECODE
import com.zoffcc.applications.undereat.ToxVars.TOX_CONNECTION
import com.zoffcc.applications.undereat.ToxVars.TOX_FILE_ID_LENGTH
import com.zoffcc.applications.undereat.ToxVars.TOX_HASH_LENGTH
import com.zoffcc.applications.undereat.ToxVars.TOX_MAX_NGC_FILESIZE
import com.zoffcc.applications.undereat.ToxVars.TOX_MAX_NGC_FILESIZE_IGNORE_OVER_THAT
import com.zoffcc.applications.undereat.ToxVars.TOX_MAX_NGC_FILE_AND_HEADER_SIZE
import com.zoffcc.applications.undereat.ToxVars.TOX_PUBLIC_KEY_SIZE
import com.zoffcc.applications.undereat.TrifaToxService.Companion.orma
import com.zoffcc.applications.undereat.TrifaToxService.Companion.resend_old_messages
import com.zoffcc.applications.undereat.TrifaToxService.Companion.resend_v3_messages
import com.zoffcc.applications.undereat.VideoInFrame.new_video_in_frame
import com.zoffcc.applications.undereat.VideoInFrame.setup_video_in_resolution
    ...
    companion object
    {
            ...
            GlobalScope.launch {
                try
                {
                    ...
                    } else if (a_TOXAV_FRIEND_CALL_STATE and ToxVars.TOXAV_FRIEND_CALL_STATE.TOXAV_FRIEND_CALL_STATE_FINISHED.value > 0)
                    {
                        ...
                        Log.i(com.zoffcc.applications.undereat.TAG, "ffmpeg_devices_stop:003")
                        ...
                        a_TOXAV_FRIEND_CALL_STATE == ToxVars.TOXAV_FRIEND_CALL_STATE.TOXAV_FRIEND_CALL_STATE_NONE.value)
                    {
                        ...
                        Log.i(com.zoffcc.applications.undereat.TAG, "ffmpeg_devices_stop:004")
                        avstatestore.state.ffmpeg_devices_stop()
                        on_call_ended_actions()
                    } else if (a_TOXAV_FRIEND_CALL_STATE and ToxVars.TOXAV_FRIEND_CALL_STATE.TOXAV_FRIEND_CALL_STATE_ERROR.value > 0)
                    {
                        Log.i(TAG, "toxav_call_state:from=$friend_number call ERROR(3)")
                        Log.i(com.zoffcc.applications.undereat.TAG, "ffmpeg_devices_stop:005")
                        avstatestore.state.ffmpeg_devices_stop()
                        on_call_ended_actions()
                    }
                } catch (_: Exception)
        ...
        fun shutdown_av_call(friend_number: Long)
        {
            ...
            else if (avstatestorecallstate.state.call_state == AVState.CALL_STATUS.CALL_STATUS_CALLING)
            {
                if (avstatestore.state.call_with_friend_pubkey_get() == tox_friend_get_public_key(friend_number))
                {
                    Log.i(com.zoffcc.applications.undereat.TAG, "ffmpeg_devices_stop:006")
                    avstatestore.state.ffmpeg_devices_stop()
